                    ...
                    <div class="info-form">
                        <form class="form-inlin justify-content-center" method="post" action="server.php">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="stud_lastname" value="<?php echo $stud_lastname; ?>" placeholder="Last Name">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="stud_firstname" value="<?php echo $stud_firstname; ?>" placeholder="First Name">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group d-flex">
                                ...
                                <input type="text" class="form-control" name="stud_year" value="<?php echo $stud_year; ?>" placeholder="Year Level">
                            </div>
                            <div class="form-group">
                                <textarea class="form-control" name="stud_address" value="<?php echo $stud_address; ?>" placeholder="Home Address" rows="3"></textarea>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" name="stud_contact" value="<?php echo $stud_contact; ?>" placeholder="Mobile Number">
                            </div>
                            <div class="form-group">
